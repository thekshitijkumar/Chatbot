...
GREETING = ['Hello! I am SPaRK. I will try my best to provide you information related to our College!']
...
DEFAULT_RESPONSES = ["I did not get you! Pardon please!","I couldn't understand what you just said! Kindly rephrase"
                     ...
                     " queries regrading DCRUST and general topics." 
					 " Shall I do a web search for that? " ]
...
def login(user=False):
    ...
    conn = sqlite3.connect('seminar2_progress\\spark\\db\\sqlite\\db\\pythonsqlite.db')
    c = conn.cursor()
