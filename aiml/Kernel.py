...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "SPaRK")
        # setting botmaster
        self.setBotPredicate("botmaster","Anonymous")
        # setting other bot attributes
        self.setBotPredicate("family","Chat-bot based on AI")
        self.setBotPredicate("species","Chat-bot")
        self.setBotPredicate("order","robot")
        self.setBotPredicate("age","2.5 months")
        self.setBotPredicate("class","Chat-bot")
        self.setBotPredicate("master","Anonymous")
        self.setBotPredicate("birthplace","Somewhere on Earth")
        self.setBotPredicate("location","India")
        self.setBotPredicate("gender","robot")
        self.setBotPredicate("favoritecolor","RGB")
        self.setBotPredicate("emotions","emotionless")
        self.setBotPredicate("version","0.0.1")
        self.setBotPredicate("language","English")
        self.setBotPredicate("nationality","Indian")
        self.setBotPredicate("maxclients","10")
        self.setBotPredicate("state","Haryana")
        self.setBotPredicate("country","India")
    ...
    def bootstrap(self, brainFile = None, learnFiles = [], commands = [],
        ...
        if self._verboseMode:
            pass#print( "Kernel bootstrap completed in %.2f seconds" % (time.clock() - start) )
    ...
    def loadBrain(self, filename):
        ...
        """
        if self._verboseMode: pass#print( "Loading brain from %s..." % filename, end="" )
        start = time.clock()
        self._brain.restore(filename)
        if self._verboseMode:
            end = time.clock() - start
            pass#print( "done (%d categories in %.2f seconds)" % (self._brain.numTemplates(), end) )
    ...
    def learn(self, filename):
        ...
        for f in glob.glob(filename):
            ...
            if self._verboseMode:
                pass#print( "done (%.2f seconds)" % (time.clock() - start) ) #suppressing the output
    ...
    def _respond(self, input_, sessionID):
        ...
        if elem is None:
            if self._verboseMode:
				#setting error message when no input found
